            ...
            <input name="_method" type="hidden" value="PATCH">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="year" id="year" value="{{ $election->year}}" style="width: 100%;">
                            @if ($errors->has('year'))
                                <span>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                              ...
                              <input type="text" class="form-control pull-right datepicker" value="{{ $election->date}}" name="date" id="datepicker">
                            </div>
                            <!-- /.input group -->
                          </div>
                          <!-- /.form group -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('start_time') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control timepicker" name="start_time" value="{{ $election->start_time}}" id="start_time" style="width: 100%;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('end_time') ? 'has-error' : '' }}">
                            ...
                            <input type="text" class="form-control timepicker1" name="end_time" value="{{ $election->end_time}}" id="end_time" style="width: 100%;">
